    ...
    <body class="antialiased">
      ...
      <div class="loader">
        ...
        <header>
            ...
            <nav>
                <a href="#"><span class="logo a"> Ledigitalmaster </span></a>
                <ul class="ul">
                  <a href="{{ route('nosFormations') }}" class="a"><li class="li">Nos formations</li></a>
                    <a href="{{ route('devisGratuis') }}" class="a"><li class="li">Un devis gratuit</li></a>
                    ...
                    <i class="fas fa-search fa-lg fa-2x mx-3"
                    style="color: wheat; display: block; margin: auto; cursor: pointer;"
                    onclick="showSearchBar()"></i>
            ...
            <div class="category">
                ...
                <p><a href="{{ route('optimisation') }}" class="a">Optimisation protection en ligne</a></p>
        ...
        <section class="bg-light">
            ...
            <div class="container py-4">
              <div class="pb-3 mb-4 border-bottom">
                <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
                  <span class="fs-4">Pour tous vos sites web</span>
                </a>
              </div>
          
              <div class="p-5 mb-4 bg-light rounded-3">
                <div class="container-fluid py-2">
                  {{-- <h1 class="display-5 fw-bold">Ordonner un site web</h1> --}}
              ...
              <div class="row align-items-md-stretch">
                <div class="col-md-6">
                  <div class="h-100 p-5 text-bg-dark rounded-3">
                    ...
                    <a class="btn btn-outline-light" href="{{ route('nousContacter') }}" type="button">Commander un site we</a>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="h-100 p-5 bg-light border rounded-3">
                    ...
                    <a class="btn btn-outline-secondary" href="{{ route('modeles') }}"  type="button">Modèles de site web</a>
                  </div>
                </div>
              </div>
                      ...
                      <div class="container px-4 py-5">
                        ...
                        <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
                          <div class="d-flex flex-column align-items-start gap-2">
                            ...
                            <a href="{{ route('nosFormations') }}" class="btn btn-primary btn-lg">Voir les formations</a>
                          </div>
                          <div class="row row-cols-1 row-cols-sm-2 g-4">
                            <div class="d-flex flex-column gap-2">
                              ...
                              <h4 class="fw-semibold mb-0">Une premiere formation</h4>
                            ...
                            <div class="d-flex flex-column gap-2">
                              ...
                              <h4 class="fw-semibold mb-0">Une deuxieme formation</h4>
                              <p class="text-muted">Paragraph of text beneath the heading to explain the heading.</p>
                            </div>
                            ...
                            <div class="d-flex flex-column gap-2">
                              ...
                              <h4 class="fw-semibold mb-0">Une troisieme formation</h4>
                              <p class="text-muted">Paragraph of text beneath the heading to explain the heading.</p>
                            </div>
                            ...
                            <div class="d-flex flex-column gap-2">
                              ...
                              <h4 class="fw-semibold mb-0">Une quatrieme formation</h4>
                              <p class="text-muted">Paragraph of text beneath the heading to explain the heading.</p>
                            </div>
                          </div>
                        </div>
          ...
          <section class="bg-light">
            <hr class="container featurette mt-5 bg-light">
              <h3 class="text-center m-5"> Nos Témoignages</h3>
            <hr class=" container featurette my-5">
        
            <div class="container" style="margin-bottom: 90px;">
                <div class="row justify-content-center">
                    <div class="card m-3 shadow rounded-5" style="width: 18rem; padding-top: 10px;">
                        <img src="{{ asset('assets/images/picture10.jpg') }}" class="card-img-top rounded-4" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                                card's content.</p>
                            {{-- <a href="{{ route('temoignages') }}" class="btn btn-primary">Voir plus</a> --}}
                        </div>
                    </div>
        
                    <div class="card m-3 shadow rounded-5" style="width: 18rem; padding-top: 10px;">
                        <img src="{{ asset('assets/images/picture11.jpg') }}" class="card-img-top rounded-4" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                                card's content.</p>
                    ...
                    <div class="card m-3 shadow rounded-5" style="width: 18rem; padding-top: 10px;">
                        <img src="{{ asset('assets/images/picture12.jpg') }}" class="card-img-top rounded-4" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                                card's content.</p>
